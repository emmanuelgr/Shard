 ...
 */
public class TutorialActivity1 extends BaseTutorialActivity{
...
@Override
Uri getVideoUri(){
	return uri = Uri.parse( "android.resource://" + getPackageName() + "/" + R.raw.tutorial_opening );
}
...
Intent getNextActivity(){
	Intent intent = new Intent( this, TutorialActivity1b.class );
