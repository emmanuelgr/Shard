 ...
 */
public class TutorialActivity3 extends BaseTutorialActivity{
...
@Override
Uri getVideoUri(){
	return uri = Uri.parse( "android.resource://" + getPackageName() + "/" + R.raw.tap_lesson );
}
...
Intent getNextActivity(){
	Intent intent = new Intent( this, TutorialActivity3b.class );
