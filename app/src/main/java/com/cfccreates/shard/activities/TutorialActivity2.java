 ...
 */
public class TutorialActivity2 extends BaseTutorialActivity{
...
@Override
Uri getVideoUri(){
	return uri = Uri.parse( "android.resource://" + getPackageName() + "/" + R.raw.drag_lesson );
}
...
Intent getNextActivity(){
	Intent intent = new Intent( this, TutorialActivity2b.class );
